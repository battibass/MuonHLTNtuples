...
for SAMPLE in ${SAMPLES[@]} ; do
    echo $SAMPLE
    ./comparePlots.exe results/rateResults_${NTUPLE_VERSION}_62X_HLT701_13TeV_20PU_25ns_${SAMPLE}.root \
	               results/rateResults_${NTUPLE_VERSION}_53X_HLT701_13TeV_25PU_25ns_${SAMPLE}.root \
